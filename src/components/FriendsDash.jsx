        ...
        inviteDivs.push(
            <div className="friend-dash-element">
                <div className="friend-dash-name">
                    <Avatar marginRight="10px" src="https://cdn.discordapp.com/attachments/747957440733249656/776683703317299240/72948731.jpg" />
                ...
                <div className="friend-dash-buttons">
                    ...
                    <Button className="reject-button" marginLeft="10px" bg="#ffa62b" border="none" _hover={{bg:"#ffb73c"}}>
                        Reject
                    </Button>
                </div>
            </div>
...
export default function FriendsDash() {
    return (
        <Tabs isFitted id="friends-dash" className="ProfileDiv" variant="enclosed">
            ...
            <TabPanels id="dash-panels" borderTop="1px solid #ede7e3;" color="#ede7e3">
